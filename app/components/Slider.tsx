...
const testSlides: Slides[] = [
  {
    id: 0,
    imgUrl: "/carousel-1.webp",
    imgAlt: "Freshly brewed coffee beans 1th image",
    header: {
      part1: "we have been serving",
      part2: "coffee",
      part3: "since 1950",
    },
  },
  {
    id: 1,
    imgUrl: "/carousel-2.webp",
    imgAlt: "Freshly brewed coffee beans 2th image",
    header: {
      part1: "we have been serving",
      part2: "coffee",
      part3: "since 1950",
  ...
  },
  {
    id: 2,
    imgUrl: "/carousel-1.webp",
    imgAlt: "Freshly brewed coffee beans 3th image",
    header: {
      part1: "we have been serving",
      part2: "coffee",
      part3: "since 1950",
  ...
  },
  {
    id: 3,
    imgUrl: "/carousel-2.webp",
    imgAlt: "Freshly brewed coffee beans 4th image",
    header: {
      part1: "we have been serving",
      part2: "coffee",
      part3: "since 1950",
...
export default function Slider() {
  ...
  if (loading) {
    return (
      <section className="bg-linear-to-br pt-[5vh] to-[#541C0B] from-[#64392D] relative w-full h-[80vh] min-h-[600px] md:h-[90vh]">
  ...
  return (
    <section
      className="h-[80vh] min-h-[600px] md:h-[90vh] @container relative select-none overflow-hidden"
    ...
    >
      <div
        className="transition-all duration-[.75s] flex w-full h-full"
          ...
          return (
            ...
            >
              <img
                ...
                fetchPriority="high"
              />
              <div className="absolute w-full h-full top-0 bg-[#4311005c] z-[-1]"></div>
      ...
      <button
        className="absolute right-[10px] focus-within:outline-none md:right-[60px] top-[55%] md:top-[52%] bg-[rgba(255,255,255,0.6)] hover:bg-[#ffffff] transition-all p-[10px] md:p-[15px] rounded-full"
      ...
      <button
        className="absolute left-[10px] focus-within:outline-none md:left-[60px] top-[55%] md:top-[52%] bg-[rgba(255,255,255,0.6)] hover:bg-[#ffffff] transition-all p-[10px] md:p-[15px] rounded-full"
